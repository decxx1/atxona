...
export default function LangSelector({scrolled, tooltipId}) {
    ...
    return (
        ...
        <div className={`${scrolled ? "hidden" : "" } flex justify-end gap-4 lg:gap-2 max-lg:py-3`}>
            ...
            <div id={"tooltip-spanish"+tooltipId} role="tooltip" className="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white bg-terteary rounded-lg shadow-sm opacity-0 tooltip">
                Español
            ...
            <div id={"tooltip-english"+tooltipId} role="tooltip" className="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white bg-terteary rounded-lg shadow-sm opacity-0 tooltip">
                English
                <div className="tooltip-arrow" data-popper-arrow></div>
            </div>
            ...
            <div id={"tooltip-portuguese"+tooltipId} role="tooltip" className="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white bg-terteary rounded-lg shadow-sm opacity-0 tooltip">
                Português
                <div className="tooltip-arrow" data-popper-arrow></div>
            </div>
        </div>
