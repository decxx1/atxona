...
export default function Header({currentLocale}){
    ...
    const classNav = () => {
        ...
        if (showNavMobile) {
            if(scrolled){
                return 'absolute text-white left-0 top-32 bg-terceary w-full flex flex-col gap-4 px-8 py-8 z-50';
            }else {
                return 'absolute text-white left-0 top-40 bg-terceary w-full flex flex-col gap-4 px-8 py-8 z-50';
            }
        }else {
            return 'hidden';
        }
